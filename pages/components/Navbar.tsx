...
const Navbar = () => {
  return (
    <nav className='bg-teal-500	 border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-amber-900'>
        ...
        >
          <ul className='flex flex-col p-4 mt-4  rounded-lg md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700'>
            <li>
              <Link
                href='/login'
                className='block py-2 pl-3 pr-4 text-white bg-teal-300 rounded md:bg-transparent md:text-teal-700 md:p-0 dark:text-white'
                aria-current='page'
              >
                Home
              </Link>
